 ...
 * imported.
 */
export declare function useWaitForTempoBlock<config extends Config = ResolvedRegister['config'], selectData = Actions.zone.waitForTempoBlock.ReturnValue>(parameters?: useWaitForTempoBlock.Parameters<config, selectData>): useWaitForTempoBlock.ReturnValue<selectData>;
export declare namespace useWaitForTempoBlock {
    type Parameters<config extends Config = ResolvedRegister['config'], selectData = Actions.zone.waitForTempoBlock.ReturnValue> = ConfigParameter<config> & QueryParameter<Actions.zone.waitForTempoBlock.ReturnValue, Actions.zone.waitForTempoBlock.ErrorType, selectData, Actions.zone.waitForTempoBlock.QueryKey<config>> & ExactPartial<Actions.zone.waitForTempoBlock.Parameters<config>>;
    type ReturnValue<selectData = Actions.zone.waitForTempoBlock.ReturnValue> = UseQueryReturnType<selectData, Error>;
}
/**
