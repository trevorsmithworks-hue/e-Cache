...
export const HeadlessWalletUtil = {
     ...
     */
    async fetchWallets(fetchOptions) {
    ...
    getWalletList() {
        return {
            ...
            wcWallets: ConnectUtil.getWalletConnectWallets(ApiController.state.wallets, ApiController.state.search),
     ...
     */
    async prefetchWalletConnectUri(_options) {
        this.resetWcUri();
     ...
     */
    async connect(wallet, namespace, options) {
...
//# sourceMappingURL=HeadlessWalletUtil.js.map