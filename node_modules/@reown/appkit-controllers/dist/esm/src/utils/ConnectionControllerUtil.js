    ...
    onConnectMobile(wallet, wcPayUrl) {
        ...
        if (wallet?.mobile_link && wcUri) {
            try {
                ...
                const { redirect, redirectUniversalLink, href, universalHref } = CoreHelperUtil.formatNativeUrl(mobile_link, uriWithPay, link_mode);
                 ...
                 */
                const shouldPreferUniversal = Boolean(OptionsController.state.experimental_preferUniversalLinks);
