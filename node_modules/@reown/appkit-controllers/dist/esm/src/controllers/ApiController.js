...
export const ApiController = {
    ...
    async fetchWalletsByPage({ page, entries: entriesOverride, badge, include: includeOverride, exclude: excludeOverride, includePayOnly, sort }) {
        const { includeWalletIds, excludeWalletIds, featuredWalletIds } = OptionsController.state;
        const chains = ChainController.getRequestedCaipNetworkIds().join(',');
    ...
    async searchWallet({ search, badge, entries: entriesOverride, page: pageOverride, include: includeOverride, exclude: excludeOverride, includePayOnly, sort }) {
