...
export class AppKitBaseClient {
    ...
    syncProvider({ type, provider, id, chainNamespace }) {
         ...
         */
        ProviderController.setProvider(chainNamespace, maybeWrapCoinbaseProvider({ connectorId: id, chainNamespace, provider }));
