 ...
 */
export declare function buildSendCallsRequest(transferData: Hex, testnet: boolean, payerInfo?: PayerInfo, dataSuffix?: Hex): {
    version: string;
    chainId: 8453 | 84532;
    calls: {
        to: Address;
 ...
 */
export declare function translatePaymentToSendCalls(recipient: Address, amount: string, testnet: boolean, payerInfo?: PayerInfo, dataSuffix?: Hex): {
    version: string;
    chainId: 8453 | 84532;
    calls: {
        to: Address;
